...
const ClassRoutine = () => {
  ...
  const [data, setData] = useState([
    { id: 1, date: '10 - 1 - 2023', content: 'প্রাথমিক শিক্ষা ক্লাস রুটিন' },
    { id: 2, date: '10 - 9 - 2015', content: 'মাধ্যমিক শিক্ষা ক্লাস রুটিন' },
    { id: 3, date: '11 - 10 - 2013', content: 'উচ্চশিক্ষা ক্লাস রুটিন' },
