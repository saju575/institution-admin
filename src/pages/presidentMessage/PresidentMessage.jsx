    ...
    <React.Fragment>
      ...
      <div id="teachers">
        <div className="teachers-title mt-4">
          <h3 className='bg-[#79929C] text-white font-medium text-md p-4'>প্রতিষ্ঠান সভাপতির বাণী</h3>
        </div>
              ...
              <div className='mt-10'>
                ...
                <form>
                  ...
                  <div className="form-group flex flex-wrap my-2 items-center ">
                    <label htmlFor="title" className='pr-4 w-32'>সভাপতির নামঃ</label>
                    <input className='outline-none px-4 py-2 bg-[#F3F3F3]' type="text" id="title" name="title" placeholder="সভাপতির নাম" />
                  </div>
                  ...
                  <div className="form-group my-4">
                    <label htmlFor="image" className='pr-4 w-32'>সভাপতির ছবিঃ</label>
