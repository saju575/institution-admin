...
const Workers = () => {
  ...
  const managerData = [
    ...
    {
      name: 'মোঃ করিম চৌধুরী',
      designation: 'প্রতিষ্ঠান কর্মকর্তা',
              ...
              <div className='mt-10'>
                <form>
                  ...
                  <div className="form-group flex flex-wrap my-2 items-center ">
                    <label htmlFor="title" className='pr-4 w-32'>কর্মকর্তা নামঃ</label>
                    <input className='outline-none px-4 py-2 bg-[#F3F3F3]' type="text" id="title" name="title" placeholder="কর্মকর্তা নাম" />
                  </div>
                  ...
                  <div className="form-group my-4">
                    <label htmlFor="image" className='pr-4 w-32'>কর্মকর্তা ছবিঃ</label>
