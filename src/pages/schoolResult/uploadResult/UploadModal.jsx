...
const validationSchema = Yup.object().shape({
  ...
  xlxFile: Yup.mixed()
    .required("XLSX ফাইল নির্বাচন করুন")
...
const UploadModal = ({
  ...
  */
  ...
  const { mutateAsync, isLoading, isError, error } = useMutation({
    mutationFn: (data) => createStudentsResult(data),
    onSuccess: async () => {
          ...
          <div className="mt-10">
            <form onSubmit={formik.handleSubmit}>
              ...
              <div className="mb-4 flex flex-col gap-1 my-3">
                <label htmlFor="classTitle" className="block w-32">
                  {heading.class}
                </label>
                <select
                  id="classTitle"
              ...
              {/* exam type */}
              <div className="mb-4 flex flex-col gap-1 my-3">
                <label htmlFor="examType" className="block  w-32">
                  {heading.term}
                </label>
                <select
                  id="examType"
              ...
              <div className="mb-4 flex flex-col gap-1 my-3">
                <label htmlFor="section" className="block  w-32">
                  {"শাখা"}
                </label>
                <select
                  id="section"
              ...
              {["নবম", "দশম", "আলিম ১ম", "আলিম ২য়", "ফাজিল"].includes(
                ...
                <div className="mb-4 flex flex-col gap-1 my-3">
                  <label htmlFor="group" className="block  w-32">
                    {"বিভাগ"}
                  </label>
                  <select
                    id="group"
              ...
              {/* year */}
              <div className="mb-4 flex flex-col gap-1 my-3">
                <label htmlFor="year" className="block  w-32">
                  বছর (2018-2035)
                </label>
                <select
                  id="year"
              ...
              {/* file */}
              <div className="mb-4 flex flex-col gap-1 my-3">
                <label htmlFor="xlxFile" className="pr-4 w-32">
                  এক্সেল ফাইল
                </label>
                <input
                  className="bg-[#F3F3F3] mt-1 p-2 block w-full border outline-none shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
