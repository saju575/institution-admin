...
const ExamRoutine = () => {
  ...
  const [data, setData] = useState([
    { id: 1, date: '10 - 1 - 2023', content: 'প্রাথমিক শিক্ষা পরিক্ষা রুটিন' },
    { id: 2, date: '10 - 9 - 2015', content: 'মাধ্যমিক শিক্ষা পরিক্ষা রুটিন' },
    { id: 3, date: '11 - 10 - 2013', content: 'উচ্চশিক্ষা পরিক্ষা রুটিন' },
    { id: 4, date: '11 - 10 - 2013', content: 'শিক্ষা প্রতিষ্ঠান পরিক্ষা রুটিন' },
  ]);
              ...
              <div className='mt-10'>
                <form>
                  <div className="form-group flex flex-wrap my-2 items-center ">
                    <label htmlFor="title" className='pr-4 w-44'>পরিক্ষা রুটিন টাইটেলঃ</label>
                    <input className='outline-none px-4 py-2 bg-[#F3F3F3]' type="text" id="title" name="title" placeholder="পরিক্ষা রুটিন টাইটেল" />
                  </div>
                  <div className="form-group flex flex-wrap my-2 items-center">
                  ...
                  <div className="form-group my-4">
                    <label htmlFor="image" className='pr-4 w-32'>পরিক্ষা রুটিন পিডিএফঃ</label>
                    <input type="file"
                      id="file"
                      name="file"
