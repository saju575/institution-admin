...
const Syllabus = () => {
  ...
  const [data, setData] = useState([
    { id: 1, date: '10 - 1 - 2023', content: 'দশম শ্রেনীর সিলেবাস - ২০২৩' },
    { id: 2, date: '10 - 1 - 2023', content: 'নবম শ্রেনীর সিলেবাস - ২০২৩' },
    { id: 3, date: '10 - 1 - 2023', content: 'ষষ্ঠ শ্রেনীর সিলেবাস - ২০২৩' },
    { id: 4, date: '10 - 1 - 2023', content: 'সপ্তম শ্রেনীর সিলেবাস - ২০২৩' },
  ]);
              ...
              <div className='mt-10'>
                <form>
                  ...
                  <div className="form-group flex flex-wrap my-2 items-center ">
                    <label htmlFor="title" className='pr-4 w-44'>সিলেবাস টাইটেলঃ</label>
                    <input className='outline-none px-4 py-2 bg-[#F3F3F3]' type="text" id="title" name="title" placeholder="সিলেবাস টাইটেল" />
                  </div>
                  ...
                  <div className="form-group my-4">
                    <label htmlFor="image" className='pr-4 w-32'>সিলেবাস পিডিএফঃ</label>
                    <input type="file"
                      id="file"
                      name="file"
