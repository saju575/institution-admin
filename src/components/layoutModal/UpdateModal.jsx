...
import { editLayoutitem } from "../../utills/editLayoutItem";
...
/* 
  components
*/
const UpdateModal = ({ id, handleModalClose, type, keyword, heading }) => {
  const {
    data,
  ...
  */
  const { mutateAsync, isLoading, isError, error } = useMutation({
    mutationFn: (value) => editLayoutitem(value),
    onSuccess: async () => {
      refetch();
