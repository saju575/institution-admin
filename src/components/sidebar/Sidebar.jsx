...
const Sidebar = () => {
  ...
  return (
    <React.Fragment>
      ...
      <div id="adminSidebar" className='adminSidebar hidden sm:block relative mr-5 shadow mt-2'>
      ...
      {/* Responsive Sidebar */}
      <div id='adminResponsiveSidebar' className={`adminResponsiveSidebar ${menuVisible ? 'visible' : ''} bg-black block sm:hidden p-8`} >
