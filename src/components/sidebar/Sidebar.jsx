...
const Sidebar = () => {
  ...
  return (
    <React.Fragment>
      ...
      <div
        id="adminSidebar"
        className="adminSidebar hidden sm:block relative mr-5 shadow mt-2"
      >
          ...
          {isAdminDropdownOpen2 && (
            <div className="dropdown-menu border p-2">
              <ul>
                ...
                <li className=" mb-1 ml-4">
                  <Link to="/calendar">একাডেমিক ক্যালেন্ডার</Link>
                </li>
              </ul>
            </div>
          )}
      ...
      {menuVisible && (
        <div
          id="adminResponsiveSidebar"
          className={`adminResponsiveSidebar ${
            menuVisible ? "visible" : ""
          } bg-black block sm:hidden p-8`}
        >
          {/* Hamburger Icon */}
          <div
          ...
          {isAdminDropdownOpen1 && (
            <div className="dropdown-menu border p-2">
              <ul>
                <li onClick={closeSidebar} className=" mb-1 ml-4">
                  <Link to="/management-committee">পরিচালনা কমিটি</Link>
                </li>
                <li className=" mb-1 ml-4">
                  <Link to="/teachers">শিক্ষকবৃন্দ</Link>
